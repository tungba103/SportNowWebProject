...
exports.getProductSearch = (req, res) => {
  Product.getProductSearch(req.params.search, (data) => {
    res.send(data);
  });
};
exports.getProductSearchByType = (req, res) => {
  Product.getProductSearchByType(req.params.search, req.params.type, (data) => {
    res.send(data);
  });
};
exports.getProductSearchByPriceRange = (req, res) => {
  Product.getProductSearchByPriceRange(req.params.search, req.params.price_from, req.params.price_to, (data) => {
    res.send(data);
  });
};
exports.getProductSearchByTypeAndPriceRange = (req, res) => {
  Product.getProductSearchByTypeAndPriceRange(req.params.search, req.params.type, req.params.price_from, req.params.price_to, (data) => {
    res.send(data);
  });
};
exports.getProductSearchSorted = (req, res) => {
  Product.getProductSearchSorted(req.params.search, req.params.value, req.params.order_type, (data) => {
    res.send(data);
  });
};
exports.getProductSearchSortedByType = (req, res) => {
  Product.getProductSearchSortedByType(req.params.search, req.params.type, req.params.value, req.params.order_type, (data) => {
    res.send(data);
  });
};
exports.getProductSearchSortedByPriceRange = (req, res) => {
  Product.getProductSearchSortedByPriceRange(req.params.search, req.params.price_from, req.params.price_to, req.params.value, req.params.order_type, (data) => {
    res.send(data);
  });
};
exports.getProductSearchSortedByTypeAndPriceRange = (req, res) => {
  Product.getProductSearchSortedByTypeAndPriceRange(req.params.search, req.params.type, req.params.price_from, req.params.price_to, req.params.value, req.params.order_type, (data) => {
    res.send(data);
  });
};
